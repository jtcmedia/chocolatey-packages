...
function global:au_GetLatest {
    $download_page = Get-GitHubLatestReleaseLinks -User "FrodeSolheim" -Repository "fs-uae-launcher"
    ...
    @{
        Version = $version
        URL64 = $url
        ReleaseNotes = "https://github.com/FrodeSolheim/fs-uae-launcher/releases/tag/v${version}"
    }
}
