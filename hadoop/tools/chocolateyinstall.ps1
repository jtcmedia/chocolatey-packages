...
$mirrors        = 'http://www.apache.org/dyn/closer.cgi/hadoop/common/hadoop-3.0.1/hadoop-3.0.1.tar.gz'
$checksum32     = 'da79ba1ac659538982604c3da94da50621399f85fb74da4a9037feae1dbd920c'
