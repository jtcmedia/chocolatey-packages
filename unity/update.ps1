...
function global:au_GetLatest {
    ...
    $regex = '.exe$'
    $editor_url = $download_page.links | ? href -match $regex | select -First 1 -Skip 2 -expand href
    $android_url = $download_page.links | ? href -match $regex | select -First 1 -Skip 3 -expand href
